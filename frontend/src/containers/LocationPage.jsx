...
const locations = [
    { lat: 32.76570649214452, long: -117.06651266267941 },
    { lat: 32.7256337, long: -117.1616766 },
...
const LocationPageContainer = () => {
    ...
    const carouselChange = (from, to) => {
        ...
        window.map.flyTo({
            center: [locations[to].long, locations[to].lat],
                ...
                <LocationCarousel
                    ...
                    information={[
                        ...
                        },
                        {
                            ...
                            lat: 32.7256001,
                            "location-img":
                                "https://scopeblog.stanford.edu/wp-content/uploads/2020/06/doctors-office-1944117-scaled-e1591229685470-1152x578.jpg",
                            long: -117.1616203,
                        ...
                        },
                        {
                            ...
                            lat: 32.7256001,
                            "location-img":
                                "https://media.pri.org/s3fs-public/styles/story_main/public/story/images/25065081582_6d669759be_o.jpg?itok=POvhiOww",
                            long: -117.1616203,
