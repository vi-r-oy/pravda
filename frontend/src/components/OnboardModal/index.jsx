        ...
        <div className="OnboardModal">
            ...
            <Carousel effect="fade" ref={carouselRef} beforeChange={carouselChange}>
                <div className="model-item" dragging={true}>
                    ...
                    <p>
                        We collect no data during your checkup, any video or audio is lost after you close this website.
                    </p>
                </div>
                <div className="model-item">
                    ...
                    <p>
                        We utilize bleeding-edge machine learning to generate a health report based off your video,
                        speech, and emotion.
                    </p>
                </div>
                <div className="model-item">
                    ...
                    <p>
                        At the end, get a list of recommended local doctors based on your conditions. After you leave,
                        we’ll purge all your data!
                    </p>
                </div>
            </Carousel>
